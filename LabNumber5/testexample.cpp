...
TEST(Task4, simple_test) {
    int Arr1Size1 = 2;
    long double** Arr1 = fillArray(Arr1Size1, Arr1Size1);
    long double** Arr2 = new long double* [Arr1Size1];
    for (int i = 0; i < Arr1Size1; ++i) {
        Arr2[i] = new long double[Arr1Size1];
    }
    Arr2[0][0] = 4;
    Arr2[0][1] = 3;
    Arr2[1][0] = 2;
    ...
    EXPECT_TRUE(Compare(reverseArray(Arr1, Arr1Size1, Arr1Size1),Arr1Size1, Arr2, Arr1Size1));
    EXPECT_FALSE(Compare(reverseArray(Arr1, Arr1Size1, Arr1Size1),Arr1Size1, Arr1, Arr1Size1));
}

TEST(Task5, Crashtest) {
    int Arr1Size1 = 4;
    int Arr1Size2 = 4;
    long long** Arr1 = fillArray(Arr1Size1, Arr1Size1, 2);
    int Arr2Size = 0;
    long long* Arr2 = new long long[Arr2Size];
    int NewSize = 0;
...
TEST(Task5, averageTest) {
    int Arr2Size = 8;
    long long* Arr2 = new long long[Arr2Size] {3,3,3,3,3,3,3,3};
    EXPECT_EQ(averageArray(Arr2,Arr2Size),3);
}